...
Open Sunsama is an open-source daily planner built for this. It keeps your tasks and your time blocks in one place, so Claude needs one connector for its planning work.
...
<Shot id="consent-claude" alt="Open Sunsama consent screen asking to allow Claude access to tasks and time blocks" caption="You approve access once. Claude never sees your password." />

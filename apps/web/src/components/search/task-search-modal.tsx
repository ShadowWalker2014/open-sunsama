...
export function TaskSearchModal({ open, onOpenChange, onSelectTask }: TaskSearchModalProps) {
  ...
  // Virtualizer for performance with many tasks
...
function TaskSearchItem({ task, isSelected, isCompleted, onClick, onComplete }: TaskSearchItemProps) {

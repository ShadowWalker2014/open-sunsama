        ...
        <div className="mb-1.5 px-0.5">
          {searchOpen ? (
            ...
            <button
              ...
              className="flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-[13px] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
            >
